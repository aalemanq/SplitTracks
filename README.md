...
7. Usa `−` y `+` para bajar o subir semitonos; el tempo y la duración se conservan.
...
La separación actual necesita una mezcla estéreo de dos canales. La transposición utiliza el filtro Rubber Band incluido en FFmpeg y crea una carpeta visible con las copias MP3 transpuestas. El procesamiento es CPU y puede tardar aproximadamente lo mismo o más que la duración de la canción según el tamaño y la memoria disponible.
